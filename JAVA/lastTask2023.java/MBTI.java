...
public class MBTI{
	private String name;
	private static String[] ExtrovertVsIntrovert = new String[5];
	...
	public void displayQuestion(){
		...
		String response = "";
		for (int question = 0; question < optionA.length; question++){
			System.out.printf("%s\t\t\t%s%n", optionA[question], optionB[question]);			
			...
			switch (question) {
				...
				case 16:
						if (response.equals("A")) {
							ExtrovertVsIntrovert[index1] = optionA[question];
							index1A++;
						}
					 	else if (response.equals("B")) {
							ExtrovertVsIntrovert[index1] = optionB[question];
							index1B++; 
						}
						index1++;
						break;
				...
				case 17:
						if (response.equals("A")) {
							SensingVsIntuitive[index2] = optionA[question];
							index2A++;
						}
					 	else if (response.equals("B")) {
							SensingVsIntuitive[index2] = optionB[question]; 
							index2B++;
						}
						index2++;
						break;
				...
				case 18:	
						if (response.equals("A")) {
							ThinkingVsFeeling[index3] = optionA[question];
							index3A++;
						}
					 	else if (response.equals("B")) {
							ThinkingVsFeeling[index3] = optionB[question]; 
							index3B++;
						}
						index3++;
						break;
				...
				case 19:
						if (response.equals("A")) {
							JudgingVsPerceptive[index4] = optionA[question];
							index4A++;
						}
					 	else if (response.equals("B")) {
							JudgingVsPerceptive[index4] = optionB[question]; 
							index4B++;
						}
						index4++;
						break;
		...
		System.out.println("Hello " + getName() + " You selected");
			for (int i = 0; i < ExtrovertVsIntrovert.length; i++){
				System.out.println(ExtrovertVsIntrovert[i]);
			}
			System.out.printf("Number of A selected: %d%n", index1A);
			System.out.printf("Number of B selected: %d%n", index1B);
			System.out.println();

			for (int i = 0; i < SensingVsIntuitive.length; i++){
				System.out.println(SensingVsIntuitive[i]);
			}
			System.out.printf("Number of A selected: %d%n", index2A);
			System.out.printf("Number of B selected: %d%n", index2B);
			System.out.println();

			for (int i = 0; i < ThinkingVsFeeling.length; i++){
				System.out.println(ThinkingVsFeeling[i]);
			}
			System.out.printf("Number of A selected: %d%n", index3A);
			System.out.printf("Number of B selected: %d%n", index3B);
			System.out.println();

			for (int i = 0; i < JudgingVsPerceptive.length; i++){
				System.out.println(JudgingVsPerceptive[i]);
			}
			System.out.printf("Number of A selected: %d%n", index4A);
			System.out.printf("Number of B selected: %d%n", index4B);
			System.out.println();	
